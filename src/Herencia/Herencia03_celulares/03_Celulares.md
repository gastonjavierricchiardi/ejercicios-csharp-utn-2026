...
_Juliana_ tiene un **Motorola G5**, y _Catalina_ tiene un **iPhone**.

> El Motorola G5 pierde 0,25 "puntos" de batería por cada llamada

> el iPhone pierde 0,1% de la duración de cada llamada en batería.
