...
Una empresa de alquiler de **vehículos** desea desarrollar una aplicación para administrar sus vehículos y 
calcular el costo de los alquileres. 
...
**Auto:** tiene un costo adicional fijo de $2.000 por día. 
- Adicional 2000$ x día

---

**Camioneta:** tiene un costo adicional de $5.000 por día y un límite de kilómetros incluidos. 
- Adicional 5000$ x día + **límite de KM**
...
**Además, algunos vehículos pueden ser utilizados para realizar entregas:**
Para ello deben cumplir con un contrato que permita conocer la capacidad de carga del vehículo y una descripción del vehículo.
